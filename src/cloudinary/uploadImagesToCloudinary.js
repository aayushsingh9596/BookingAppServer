...
var fs_1 = require("fs");
var uploadImages = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var uploadedImageUrls, _i, _a, file, result, _b, _c, file, error_1;
        ...
        switch (_d.label) {
            ...
            case 5:
                if (uploadedImageUrls.length > 0) {
                    for (_b = 0, _c = req.files; _b < _c.length; _b++) {
                        file = _c[_b];
